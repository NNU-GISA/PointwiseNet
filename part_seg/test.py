...
hdf5_data_dir = os.path.join('/home/code/Dataset/Pointdata/data/part_seg', 'hdf5_data')
ply_data_dir = os.path.join('/home/code/Dataset/Pointdata/data/part_seg', 'PartAnnotation')
gpu_to_use = 0
    ...
    with tf.Session(config=config) as sess:
        ...
        for cat_idx in range(NUM_OBJ_CATS):
            ...
            if total_per_cat_seen[cat_idx] > 0:
                ...
                mean_iou += total_per_cat_iou[cat_idx] / total_per_cat_seen[cat_idx]
        printout(flog,  '\t '+'mean IOU: ' +str(mean_iou/16))
