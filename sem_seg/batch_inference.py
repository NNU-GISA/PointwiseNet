...
parser.add_argument('--model_path', default='log5/model.ckpt', help='model checkpoint file path')
parser.add_argument('--dump_dir', default='log5/dump', help='dump folder path')
parser.add_argument('--output_filelist', default='log6/output_filelist.txt', help='TXT filename, filelist, each line is an output for a room')
parser.add_argument('--room_data_filelist', default='meta/area5_data_label.txt', help='TXT filename, filelist, each line is a test room data label file.')
...
def evaluate():
    ...
    for room_path in ROOM_PATH_LIST:
        room_path = room_path.replace('/home/djz/code/PointVLAD/model/data', '/home/djz/code/Dataset/Pointdata/data/sem_seg')
